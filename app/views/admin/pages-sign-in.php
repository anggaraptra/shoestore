...
<body>
								...
								<div class="m-sm-4">
									<form action="<?= BASEURL; ?>/login/process" method="POST">
										...
										<div class="text-center mt-3">
											<button type="submit" class="btn btn-lg btn-primary" name="login-admin">Sign in</button>
										</div>
									</form>
								</div>
							</div>
	...
	<script src="<?= BASEURL; ?>/assets/sweetalert/sweetalert2.all.min.js"></script>
