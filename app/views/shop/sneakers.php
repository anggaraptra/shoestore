<div class="container-fluid mb-5 sneakers">
    <div class="row">
        <div class="col p-4">
            <h3>Sneakers</h3>
        </div>
            ...
            <?php foreach ($data['sneakers'] as $snk) : ?>
                <div class="container-fluid card card-shoes mb-5" style="width: 16rem;" data-bs-toggle="tooltip" title="<?= $snk['nama_shoes']; ?>">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><?= rp($snk['harga']); ?></p>
                        <a href="" data-bs-toggle="modal" data-bs-target="#checkModal" class="btn modalCheck" data-id="<?= $snk['id']; ?>">Detail</a>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php else : ?>
