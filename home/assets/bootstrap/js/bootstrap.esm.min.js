...
class Carousel extends BaseComponent {
  ...
  _addTouchEventListeners() {
    ...
    SelectorEngine.find(SELECTOR_ITEM_IMG, this._element).forEach((e) => {
      ...
      this._pointerEvent
        ? (EventHandler.on(this._element, EVENT_POINTERDOWN, (e) => t(e)), EventHandler.on(this._element, EVENT_POINTERUP, (e) => n(e)), this._element.classList.add("pointer-event"))
        : (EventHandler.on(this._element, EVENT_TOUCHSTART, (e) => t(e)), EventHandler.on(this._element, EVENT_TOUCHMOVE, (e) => i(e)), EventHandler.on(this._element, EVENT_TOUCHEND, (e) => n(e)));
  }
  _keydown(e) {
...
class Dropdown extends BaseComponent {
  ...
  show() {
    ...
    this._inNavbar ? Manipulator.setDataAttribute(this._menu, "popper", "none") : this._createPopper(t),
      "ontouchstart" in document.documentElement && !t.closest(".navbar-nav") && [].concat(...document.body.children).forEach((e) => EventHandler.on(e, "mouseover", noop)),
      this._element.focus(),
...
class FocusTrap {
  ...
  activate() {
    ...
    this._isActive ||
      (t && e.focus(), EventHandler.off(document, EVENT_KEY$7), EventHandler.on(document, EVENT_FOCUSIN$1, (e) => this._handleFocusin(e)), EventHandler.on(document, EVENT_KEYDOWN_TAB, (e) => this._handleKeydown(e)), (this._isActive = !0));
  }
  deactivate() {
...
class Tooltip extends BaseComponent {
  ...
  show() {
    ...
    Data.set(n, this.constructor.DATA_KEY, this),
      this._element.ownerDocument.documentElement.contains(this.tip) || (a.append(n), EventHandler.trigger(this._element, this.constructor.Event.INSERTED)),
    ...
    this._queueCallback(
      () => {
        this._isWithActiveTrigger() ||
          ("show" !== this._hoverState && e.remove(), this._cleanTipClass(), this._element.removeAttribute("aria-describedby"), EventHandler.trigger(this._element, this.constructor.Event.HIDDEN), this._disposePopper());
      },
      this.tip,
      t
    ),
  ...
  setElementContent(e, t) {
    if (null !== e)
      return isElement(t)
        ? ((t = getElement(t)), void (this._config.html ? t.parentNode !== e && ((e.innerHTML = ""), e.append(t)) : (e.textContent = t.textContent)))
